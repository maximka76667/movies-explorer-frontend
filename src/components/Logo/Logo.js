  ...
  return (
    <Link to="/" className="logo">
      <svg className="logo__img" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path className="logo__part" fill-rule="evenodd" clip-rule="evenodd" d="M15.1538 19C15.1538 21.1242 16.8758 22.8462 19 22.8462C21.1242 22.8462 22.8462 21.1242 22.8462 19H25C25 22.3137 22.3137 25 19 25C15.6863 25 13 22.3137 13 19H15.1538Z" fill="#2BE080" />
      </svg>
    </Link>
  )
}
